...
namespace NSEasyBuy.Repository.Data
{
    ...
    {
        public string _ConnnectionString = "";              

        public DataAccessManager(Microsoft.Extensions.Options.IOptions<ConnectionString> connectionString)
        {
            _ConnnectionString = connectionString.Value.DefaultConnection;
        }
        /// <summary>
